...
import heroImg from '../../assets/images/about/desktop/image-hero.jpg';
import heritageImg from '../../assets/images/about/desktop/image-heritage.jpg';
  ...
  return (
    <main className={classes.about}>
      ...
      <section className={classes.team}>
        ...
        <div>
          {team.map((member) => (
            <TeamCard key={member.id} image={member.image} name={member.name} role={member.role} />
          ))}
        </div>
      </section>
    </main>
